...
export default function updateStudentGradeByCity(students, city, newGrade) {
  return students
    .filter((student) => student.location === city)//filter student from specific city
    .map((student) => {
      const grades = newGrade.find((grade) => grade.studentId === student.id);//iterate through filterd student and update grades
